...
function arbitrageCalculate(highHome, lowAway, lowHome, highAway) {
    var oddsA = (1 / highHome) * 100
    var oddsB = (1 / lowAway) * 100
    console.log("oddsA = " + oddsA)
    console.log("oddsB = " + oddsB)


    var percentage1 = oddsA + oddsB
    ...
    var oddsC = (1 / highAway) * 100
    var oddsD = (1 / lowHome) * 100

    var percentage2 = oddsC + oddsD
    ...
    return new Promise((resolve, reject) => {
        axios.get(baseURL, {
            ...
            for (var i = 0; i < response.data.data.length; i++) {
                ...
                //Send arbitrage data
                var isArbitrage = arbitrageCalculate(
                    highest_home_odds_index,
                    lowest_away_odds_index,
                    lowest_home_odds_index,
                    highest_away_odds_index
                );

                events[i][5] = isArbitrage
                console.log("Arbitrage here")
                console.log(isArbitrage)
